...
public class ValiderAjoutDoc extends Action {
	...
	String execute(HttpServletRequest req, HttpServletResponse resp) {
	    try {
	        ...
	        // Obtenez le dossier de destination où vous souhaitez stocker les fichiers téléchargés
	        String uploadDirectory = "C:\\Users\\HP\\Desktop\\gestion_document_v3\\gestion_document_v3\\src\\main\\webapp\\documents";
